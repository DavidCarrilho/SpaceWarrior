...
/**
 * Classe Sprite, base para outras classes
 */
public class Sprite {
    ...
    public final void desenhar(Canvas canvas, Paint paint, GameView gameView){
        frame++;
        antesDeDesenhar(canvas, paint, gameView);
